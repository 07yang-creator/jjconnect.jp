 ...
 * 功能：
 * - 搜索框
 * - 官方分类板块（从 categories 表读取）
 * - 授权用户主页入口
 * 
 * 样式：Tailwind - fixed right-0 h-full w-64 border-l bg-white/80 backdrop-blur-md
 * 
...
export default function RightSidebar({ env, user }: RightSidebarProps) {
  ...
  return (
    <>
      {/* 桌面端右侧边栏 - 固定位置，透明模糊背景 */}
      <aside 
        className="hidden md:block fixed right-0 top-0 h-full w-64 bg-white/80 backdrop-blur-md border-l border-gray-200/50 shadow-lg overflow-y-auto z-40"
        style={{
